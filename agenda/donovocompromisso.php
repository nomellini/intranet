<?
	...
	// Algum teste, pois sempre ir� passar pela gravação
...
//	if (true) {
	...
	$local = mysql_real_escape_string ($local);
		...
		atrav�s dos campos checkbox de sele��o de participantes. O Resultado
		� um array com os IDs dos participantes selecionados.
		*/
	...
	function Envia_email($id_sala, $data, $hora, $nomeusuario)
	{
		...
		if ($Email_Sala) {
			...
			mail2($Email_Sala, $titulo, "Novo agendamento de sala: <b>$nome</b> no dia $data �s $hora por $nomeusuario", $titulo);
		}
	}
?>
