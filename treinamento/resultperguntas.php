...
include_once ('cabeca.inc.php');
 ...
 $sSQL = "SELECT  * FROM perguntas where id = $id;";
 $result = mysql_query($sSQL);   
   
 while ($linha = mysql_fetch_object($result)) {
      $id = $linha->id;
      $descricao = $linha->descricao;
	  $opcao_a = $linha->opcao_a;
	  $opcao_b = $linha->opcao_b;
	  $opcao_c = $linha->opcao_c;
	  $opcao_d = $linha->opcao_d;
	  $resp = $linha->resp;
...
<div align="center">
  <span class="style16 style3"><strong>  Lista de Perguntas<br>
  <br>
  </strong></span></div>
...
for ($x=0;$x < $tot_perguntas;$x++) {
       ...
       $sSQL = "select * from perguntas where id = $id[$x];"; 
       if (!$result = mysql_query($sSQL)) {
           echo "<br><br>Problema na tabela de perguntas</b><br>";
       };
       if (!$linha = mysql_fetch_object($result)) {
          echo "<br><br>Pergunta $id[$x] não cadastrado.</b><br>";
       };
       $id = $linha->id; 
       $descricao = $linha->descricao; 
	   $opcao_a = $linha->opcao_a; 
...
?>
  ...
  <tr bgcolor="#006699">
    <td width="16%" height="22"><div align="left" class="style17 style1 style8"><strong><span class="style4">C&oacute;digo</span></strong></div></td>
    <td width="56%" height="22"><span class="style15 style1 style8"><strong>Descri&ccedil;&atilde;o da Prova</strong></span></td>
    <td width="28%" height="22"><span class="style15 style1 style8"><strong> Origem </strong></span></td>
    </tr>
  
  <tr>
    <td><span class="style3 style8"><? echo $id        ?></span></td>
    <td><span class="style3 style8"><? echo $descricao ?></span></td>
    <td><span class="style3 style8"><? echo $sistema   ?></span></td>
  </tr>
...
for ($x=0;$x < $tot_perguntas;$x++) {
       ...
       if (!$linha = mysql_fetch_object($result)) {
          echo "<br><br>Pergunta $id[$x] n&atilde;o cadastrado.</b><br>";
       };
       $id = $linha->id; 
       $descricao = $linha->descricao; 
	   $opcao_a = $linha->opcao_a; 
...
?>
  <tr bgcolor="#006699">
    <td width="16%" height="22"><div align="left" class="style17 style1 style8"><strong><span class="style4">Alternativas</span></strong></div></td>
    <td width="84%" height="22"><span class="style15 style1 style8"><strong>Descri&ccedil;&atilde;o da Resposta </strong></span></td>
    </tr>
  <tr>
    <td><span class="style3 style8"> A</span></td>
    <td><span class="style3 style8"><? echo $opcao_a ?>&nbsp;</span></td>
    </tr>
  <tr>
    <td><span class="style3 style8">B</span></td>
    <td><span class="style3 style8"><? echo $opcao_b   ?> &nbsp;</span></td>
  </tr>
  <tr>
    <td><span class="style3 style8">C </span></td>
    <td><span class="style3 style8"><? echo $opcao_c   ?>&nbsp;</span></td>
  </tr>
  <tr>
    <td><span class="style3 style8"> D</span></td>
    <td><span class="style3 style8"><? echo $opcao_d   ?>&nbsp;</span></td>
  </tr>
  <tr>
    <td><span class="style3 style8">Correta</span></td>
    <td><span class="style3 style8"><? echo $resp      ?>&nbsp;</span></td>
  </tr>
  <?
//  };
 ?>
