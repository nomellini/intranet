...
<html>
<head>
<title><?=$id_chamado?> : Hist&oacute;rico</title>
...
?>
<-- Link para o chamado 
<? echo "<div class=\"dragTest\" style=\"-webkit-user-drag: element; -webkit-user-select:none;\"  draggable=\"true\" ondragstart=\"setDrag($id_chamado,'');return OnDragStart1(event)\">Simples</div>";?><? echo "<div class=\"dragTest\" style=\"-webkit-user-drag: element; -webkit-user-select:none;\"  draggable=\"true\" ondragstart=\"setDrag($id_chamado,0);return OnDragStart2(event)\">Completo</div>";?>
...
<? } ?>
    ...
    <script type="text/javascript">
        ...
        function OnDragStart2 (event) {
			id_chamado = document.drag1.id_chamado.value;
			link = "Chamado [" + id_chamado + "] - http://192.168.0.14/a/historicochamado3.php?id_chamado=" + id_chamado;
            event.dataTransfer.setData ("text/plain", link);
            return true;
        }
