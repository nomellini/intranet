<?
	...
	$ch = statChamadosPorDia($atendimento, $o);
...
<form name="form" method="post" action="chamadospordia.php">
...
<table width="71%" border="0" cellspacing="1" cellpadding="1" align="left" bgcolor="#333333" height="8">
  <tr bgcolor="#CCCCCC"> 
    <td width="17%" align="center"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="javascript:document.form.ordem.value='dataa'; document.form.submit();">Data</a></font></td>
    <td width="55%"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:document.form.ordem.value='dia'; document.form.submit();">Dia 
      da semana</a></font></td>
...
?>
  <tr bgcolor="#FCE9BC"> 
    ...
    <td width="55%" height="16" valign="middle"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
      <a href="relat2.php?dataf=<?=$dataa?>&datai=<?=$dataa?>#inicio"> 
      <?=$dia?>
      </a></font></td>
...
?>
  ...
  <tr bgcolor="#FFFFFF">
    <td width="17%" height="16" align="left">&nbsp;</td>
    <td width="55%" height="16" align="right">M&eacute;dia : </td>
    <td width="13%" height="16" align="center"> 
       <?
        $ct = sprintf ("%02.2f", $somaChamados/$total);
		echo $ct;
	    
	   ?>
    </td>
    <td width="15%" height="16" align="left">ch/dia</td>
  </tr>
</table>
