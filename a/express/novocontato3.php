...
?>
        <input type="checkbox" name="comunica" value="1" onClick="alterna(comunica)"> Comunicar outras áreas: <br>
...
<?
	...
	if($pode) {
		if ($JaFoiParaBase) 
		{
			echo "<h3>Este chamado já está na base. Tenha certeza de que a documentação mudou antes de mandar novamente</h3>";
		}
?>
