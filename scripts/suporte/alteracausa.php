...
<title>suporte :: manutencao de causas</title>
<!-- #EndEditable --> 
...
<div align="center"> 
        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" --> 
              ...
              <p align="left"> <br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="stats.php">Ver estat&iacute;sticas</a><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="novo.php">Inclu&iacute;r 
                um novo t&iacute;tulo</a> <br>
 ...
 $sSQL = "Select * from descr where id = $id_causa";
...
?> <br>
              Altera&ccedil;&atilde;o de causa 
              <form method="post" action="alteracausa02.php">
                <p>Causa<br>
                  <textarea name="causa" cols="50" rows="5"><?=$causa?></textarea>
                </p>
                <p>Solu&ccedil;&atilde;o<br>
                  <textarea name="solucao" cols="50" rows="5"><?=$solucao?></textarea>
                </p>
                <p> 
                  <input type="checkbox" name="deleta" value="sim">
                  Apagar essa causa 
              ...
              <p><a href="http://192.168.0.5/suporte/novo02.php?id_titulo=<?=$id_titulo?>">Inclu&iacute;r 
                uma nova Causa</a><br>
                Ver e/ou alterar uma das seguintes Causas<br>
                <br>
                <?
 mysql_connect(localhost, root, marcia);
 mysql_select_db(suporte);
 $sSQL = "SELECT * FROM descr where id_titulo=$id_titulo;";
 $result = mysql_query($sSQL);
 while($linha = mysql_fetch_object($result)) {
 $causa = $linha->causa;
 $id_causa = $linha->id;
?> -><a href="alteracausa.php?id_titulo=<?=$id_titulo?>&id_causa=<?=$id_causa?>"><?=$causa?></a><BR>
                <? 
}
?> </p>
              <!-- #EndEditable --></td>
