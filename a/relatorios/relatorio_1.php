...
$query_rsSistema = "SELECT id_sistema, sistema FROM sistema";
...
mysql_select_db($database_sad, $sad);
$query_rsCategoria = "SELECT id_categoria, categoria FROM categoria ORDER BY sistema_id ASC, categoria";
...
mysql_select_db($database_sad, $sad);
$query_rsTipo = "SELECT * FROM origem";
...
mysql_select_db($database_sad, $sad);
$query_rsMotivo = "SELECT * FROM motivo";
...
<form name="form" method="post" action="relatorio_1.php">
  <?
if (
...
?>
  <table width="98%" border="0" cellspacing="1" cellpadding="1" bgcolor="#000000" align="center">
    <tr bgcolor="#FCE9BC">
      ...
      <td width="77%"><select name="consultor" class="unnamed1">
