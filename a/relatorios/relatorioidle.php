...
//	$origem = 1;	
	$ch = statIdle($consultor, $datar, $origem);	
	$total = count($ch);
...
<form name="form" method="post" action="relatorioidle.php">
...
?>
  <tr bgcolor="#FCE9BC" align="center" valign="middle"> 
    ...
    <td width="10%" height="16"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
      <A HREF="/a/historicochamado.php?id_chamado=<?=$chamado_id?>" >	
      <?=$chamado_id?>
      <br>
      <?=$origem?>
      </a> </font></td>
    ...
    <td width="10%" height="16" align="center">  <?= SegToHora($seg); $idleAcc += $seg; ?>  </td>      
  </tr>
  <? }
	  $ha = $horae;  
  }
