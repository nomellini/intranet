...
<script>
function fdata(src) {
  if (src.value.length==2 ){src.value=src.value+":";}
}
function atualiza() {
	var ids;
...
<form name="form1" method="post" action="donovocompromisso.php">
  <table width="100%" border="0" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td width="2%" rowspan="10" align="left" valign="top"><font color="#003366" size="3">
        <?
      ...
      <td width="0%" rowspan="10" align="left" valign="top" bgcolor="#333333"><img src="figuras/1pixel.gif" width="1" height="1"></td>
      <td width="35%" rowspan="10" align="left" valign="top"><span id="compromissos"></span></td>
    </tr>
    <tr>
      <td valign="top">Hora </td>
      <td>das
        <input name="hora" type="text" class="borda_fina" id="hora" size="6" maxlength="5" onKeyPress="fdata(this)">
        (hh:mm) at&eacute;
        <input name="horafim" type="text" class="borda_fina" id="horafim" size="5" maxlength="5" onKeyPress="fdata(this)">
        (hh:mm) </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="RepeatEvent" type="checkbox"  id="RepeatEvent" value="1" onClick="AlternaDataFinal()">
        ...
        <input name="rdia" type="text" class="borda_fina" id="rdia" value="<?=$dia?>" size="3" maxlength="2" alt="Repetir at� este dia">
        /
        <input name="rmes" type="text" class="borda_fina" id="rmes" value="<?=$mes?>" size="3" maxlength="2">
        /
        <input name="rano" type="text" class="borda_fina" id="rano" value="<?=$ano?>" size="5" maxlength="4">
        --&gt;
        <input type="radio" name="ferias" id="radio" value="1">
        Ausente [Marcar este item para n&atilde;o receber chamados no per&iacute;odo]</div></td>
    </tr>
    <tr>
...
function listasalas(ADia, AMes, AAno) {
 ...
 Ahf = document.form1.horafim.value;
  window.open('listasalasdisponiveis.php?dia='+ADia+'&mes='+AMes+'&ano='+AAno+'&hi='+Ahi+'&hf='+Ahf, "Sele��o", "scrollbars=yes, height=488, width=600");
}

</script>

<script>
	function AlternaDataFinal()	{
		var chbox = document.form1.RepeatEvent;
		var item = divRepeat;
