...
<?
 ...
 if ($acao=="inserir") {
   $sSQL = "INSERT INTO grupo (descricao) VALUES ('$grupo');";
   mysql_query($sSQL);   
 } else if ($acao=="deletar") {
   $sSQL = "DELETE FROM grupo where id = $id_grupo;";
   mysql_query($sSQL);
 } else if ($acao=="alterar") {
   $sSQL = "UPDATE grupo SET descricao = '$grupo' where id=$id_grupo;";
   mysql_query($sSQL);
 } 
?>
...
<p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Grupos:</font></p>
<form name="form" method="post" action="grupo.php">
  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Caso queira alterar 
    ...
    <br>
    <input type="text" name="grupo" size="30" maxlength="150" class="unnamed1">
  ...
  <table width="500" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="62%"> 
        <div align="center"><i><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000099">grupo</font></i></div>
      </td>
      <td width="28%"> 
 ...
 ?>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="28%"> 
        <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="javascript:document.form.acao.value='deletar'; document.form.id_grupo.value=<?=$id?>;deleta('<?=$nome?>');">deleta</a> 
          / <a href="javascript:document.form.acao.value='alterar'; document.form.id_grupo.value=<?=$id?>;document.form.submit();">Altera</a></font></div>
      </td>
    </tr>
    <?}?>
  </table>
