...
<title>suporte :: manutenção</title>
<!-- #EndEditable --> 
          ...
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" --> 
              <p align="center"><font size="3"><br>
                &Aacute;rea de manuten&ccedil;&atilde;o de suporte</font></p>
              <p align="left"> <br>
                ...
                <br>
                <br>
                Para alterar algum t&iacute;tulo, clique no link <?
 mysql_connect(localhost, root, marcia);
 mysql_select_db(suporte);    

 $sSQL = "Select distinct t.id as id_t, t.titulo, s.so from titulo t, so s where (s.id = t.id_so) order by so, titulo";
...
?> <font size="1"> <?
      $titulo = $linha->titulo; ?>-<a href="altera.php?id=<?=$id?>"><?=$titulo?></a><br>
                </font> <?
}
?> </p>
              <p>&nbsp;</p>
