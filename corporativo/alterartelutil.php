...
<title>Altera&ccedil;&atilde;o / Inclus&atilde;o de telefone de fornecedor</title>
<!-- #EndEditable --> 
...
?>
              ...
              <p class="Titulo" align="center"><a href="/corporativo/index.php">Corporativo</a> : <?echo $action?> de Telefone de Fornecedor</p>
              <p> <?
 ...
 if ($id) {
   ...
   $sSQL = "select * from telUteis where id = $id;"; 
...
?> </p>
              <form name="form" action="tel_caduteis.php" method="post" >
<script language="JavaScript">
function confirma() {
	...
	document.form.submit();
                ...
                <table width="95%" border="0" align="center">
                  <tr> 
                    <td colspan="2"> 
                      <div align="center"><a name="colaborador"></a>Utilize esta 
                        &aacute;rea para cadastrar um <b>Telefone de Fornecedor</b></div>
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                  ...
                  <tr> 
                    ...
                    <td width="77%"> 
                      <input type="text" name="telefone" size="50" value="<?echo $telefone ?>">
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                    ...
                    <td width="77%"> 
                      <input type="text" name="fax" size="50" value="<? echo $fax?>">
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                    ...
                    <td width="77%"> 
                      <input type="text" name="email" size="50" maxlength="100" value="<?echo $email?>">
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                    ...
                    <td width="77%"> 
                      <input type="text" name="homepage" size="50" value="<?echo $homepage?>">
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%">&nbsp;</td>
                    <td width="77%"> 
                      ...
                      <input type="hidden" name="divisaooriginal" value="<?echo $divisao?>">
                    </td>
                  </tr>
                </table>
              </form>
