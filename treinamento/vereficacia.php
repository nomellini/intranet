...
if ($nome) 
	$sSQL = "SELECT * FROM eficacia where month(datadevolucao) = $mes and year(datadevolucao) = $ano and treinando like '%$nome%' order by $ordem";
else
	$sSQL = "SELECT * FROM eficacia where month(datadevolucao) = $mes and year(datadevolucao) = $ano order by $ordem, titulo  ";
        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" -->
							<form action="vereficacia.php" method="post" name="form">
								<table width="100%" border="0" align="center">
									<tr>
										<th align="center"><span class="style8">Relat&oacute;rio de Efic&aacute;cia do Treinamento</span></th>
									</tr>
									<tr>
										<td><table width="100%" border="1" align="left">
												<tr bgcolor="#D7FFFF">
													<td align="center" valign="middle" bgcolor="#006699"><span class="style1"><strong>Procure pelo m&ecirc;s e ano </strong></span></td>
												</tr>
												<tr>
													<td align="center" valign="middle" bgcolor="#DBF0EE"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">M&ecirc;s </font>
...
?>
												<tr>
													<td bgcolor="#DBF0EE" color="000000";><span class="style13 style4 style4 style4 style4"><?echo "<a href=resulteficacia.php?id=$id>$titulo</a>"?></span></td>
													<td bgcolor="#DBF0EE"><span class="style13 style4 style4 style4 style4"><?echo "<a href=resulteficacia.php?id=$id>$treinando</a>"?></span> </td>
													<td bgcolor="#DBF0EE"><span class="style7 style7 style4 style4 style8 style4 style4 style4 style4"><? echo "<a href=resultavatre.php?id=$id >$dia</a>"?>/ <? echo "<a href=resultavatre.php?id=$id >$mes</a>"?></span><span class="style4 style4 style4 style4">/<?echo "<a href=resultavatre.php?id=$id >$ano</a>"?></span></td>
												</tr>
												<? } ?>
												<? if(!$treinando){ ?>
												<tr>
													<td colspan="3"><div align="center"><span class="style13">Não há eficácia para o período selecionado </span></div></td>
												</tr>
												<? } ?>
											</table></td>
									</tr>
									<tr>
										<td><a href="relatorios.php" class="style4">Voltar</a></td>
									</tr>
								</table>
							</form>
							<!-- #EndEditable --></td>
