...
<?
  if ($id) {
    ...
    $sql = "Select nome, email from TelCol where id=$id";
    $result = mysql_query($sql);
    $linha = mysql_fetch_object($result);
    $nome=$linha->nome;
    $email_to=$linha->email;

    $para = "$nome <$email_to>";

    $email_subject="Feliz Aniversário";
    $email_body="$nome,
...
?>
              ...
              <p align="center" class="Titulo">Envio de email</p>
              <form method="post" action="/corporativo/email/sendmail.php" name="form">
                <table width="100%" border="0">
                  <tr valign="top"> 
                    <td width="28%"> 
                      <div align="right">Seu Nome : </div>
                    </td>
                    <td width="72%"> 
                      <input type="text" name="email_from_name" size="50">
                    </td>
                  </tr>
                  <tr valign="top"> 
                    <td width="28%"> 
                      <div align="right">Seu E-mail : </div>
                    </td>
                    <td width="72%"> 
                      <input type="text" name="email_from_email" size="50">
                    </td>
                  </tr>
                  <tr valign="top"> 
                    <td width="28%"> 
                    ...
                    <td width="72%"> 
                      <input type="text" name="email_to" size="50" value="<? echo $para?>">
                    </td>
                  </tr>
                  <tr valign="top"> 
                    <td width="28%"> 
                    ...
                    <td width="72%"> 
                      <input type="text" name="email_subject" size="50" value="<? echo $email_subject?>">
                    </td>
                  </tr>
                  <tr valign="top"> 
                    <td width="28%"> 
                    ...
                    <td width="72%"> 
                      <textarea name="email_body" cols="50" rows="6"><?echo $email_body?></textarea>
                    </td>
                  </tr>
                </table>
                <p align="center"> 
