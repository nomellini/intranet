          ...
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" --> 
              <p style='text-align:center'><br>
                <span class="Titulo"><a href="/corporativo/qt/index.html">Qualidade</a> 
                : <span style='font-size:16.0pt;
'><font size="3">3Q1POC</font></span></span></p>
              <p style='text-align:center' align="left">
                <blockquote>
                  <p align="left">Clique <a href="/corporativo/qt/procedientos/3q1poc.doc">aqui</a> 
                    para fazer o dowload do arquivo.</p>
                </blockquote>
              </p>
              <table border=1 cellspacing=0 cellpadding=0 bgcolor=silver width="99%" align="center">
                <tr> 
                  <td colspan=6 valign=top class="Normal"> 
                    <h1><font size="4">PLANO DE AÇÃO</font></h1>
                  </td>
                </tr>
                <tr> 
                  <td width=102 valign=top bgcolor="#E0E0E0" class="Normal"> 
                    <p align=center style='text-align:center'><b>O Que Fazer</b></p>
                  </td>
                  <td width=95 valign=top bgcolor="#E0E0E0" class="Normal"> 
                    <p align=center style='text-align:center'><b>Quando Fazer</b></p>
                  </td>
                  <td width=85 valign=top bgcolor="#E0E0E0" class="Normal"> 
                    <p align=center style='text-align:center'><b>Quem</b></p>
                  </td>
                  <td width=172 valign=top bgcolor="#E0E0E0" class="Normal"> 
                    <p align=center style='text-align:center'><b>Por Que Fazer</b></p>
                  </td>
                  <td width=82 valign=top bgcolor="#E0E0E0" class="Normal"> 
                    <p align=center style='text-align:center'><b>Onde</b></p>
                  </td>
                  <td width=214 valign=top bgcolor="#E0E0E0" class="Normal"> 
                    <p align=center style='text-align:center'><b>Como Fazer</b></p>
                  </td>
                </tr>
                <tr> 
                  <td width=102 valign=top bgcolor="transparent" class="Normal" height="262">&nbsp; 
                  </td>
                  <td width=95 valign=top bgcolor="transparent" class="Normal" height="262">&nbsp; 
                  </td>
                  <td width=85 valign=top bgcolor="transparent" class="Normal" height="262">&nbsp; 
                  </td>
                  <td width=172 valign=top bgcolor="transparent" class="Normal" height="262">&nbsp; 
                  </td>
                  <td width=82 valign=top bgcolor="transparent" class="Normal" height="262">&nbsp; 
                  </td>
                  <td width=214 valign=top bgcolor="transparent" class="Normal" height="262">&nbsp; 
                  </td>
                </tr>
              </table>
              <p>&nbsp;</p>
