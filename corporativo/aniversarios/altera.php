...
<?
				...
				$sSQL = "SELECT id, nome, dia, mes FROM funcionarios Where id = $id;"; 
			...
			?>
              ...
              <form name="form1" method="post" action="doaltera.php">
                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                  <tr> 
                    <td width="13%">Nome</td>
                    <td width="87%"><input name="nome" type="text" id="nome" value="<?=$nome?>" size="50" maxlength="50"></td>
                  </tr>
                  <tr> 
                    <td>Dia/Mes</td>
                    <td><input name="dia" type="text" id="dia" value="<?=$dia?>" size="3" maxlength="2">
                      / <input name="mes" type="text" id="mes" value="<?=$mes?>" size="3" maxlength="2"></td>
                  </tr>
                  <tr> 
                    <td>&nbsp;</td>
                    <td><input type="submit" name="Submit" value="alterar"> <input name="excluir" type="checkbox" id="excluir" value="1">
