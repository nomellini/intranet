...
?>
              ...
              <p class="Titulo" align="center"><a href="/corporativo/index.php">Corporativo</a> : <?echo $action?> de Telefone de Ex-Colaborador</p>
              <p> <?
 ...
 if ($id) {
   ...
   $sSQL = "select *  from Telexcol where id = $id;"; 
...
?> </p>
              <form name="form" action="tel_cadexcol.php" method="post" >
<script language="JavaScript">
function confirma() {
  ...
  if (confirm('Tem certeza que deseja excluir os dados ?')) {
	...
	document.form.submit();
                ...
                <table width="95%" border="0" align="center">
                  <tr> 
                    <td colspan="2"> 
                      <div align="center"><a name="excolaborador" id="excolaborador"></a>Utilize esta 
                  ...
                  <tr> 
                    ...
                    <td width="77%"> 
                      <input name="email" type="text" id="email" value="<?echo $email ?>">                    </td>
                  </tr>
                  <tr> 
                    <td width="23%">&nbsp;</td>
                    <td width="77%"> 
                      ...
                      <input type="hidden" name="tipo" value="excol">
