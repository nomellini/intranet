...
$query_rsUsuarios = "SELECT id_usuario, concat(nome, ' - ',            (select count(1) from chamado where destinatario_id  = id_usuario and status = 2 and visible = 1)) nome FROM usuario WHERE ativo = 1 and (area=2 or id_usuario=90 or id_usuario=98 or id_usuario=14 or id_usuario = 85) ORDER BY nome ASC";
