...
<link rel="stylesheet" href="../a/todo/stilos.css" type="text/css">
<link href="../a/stilos.css" rel="stylesheet" type="text/css">
</head> <body bgcolor="#FFFFFF" background="figuras/fundo.gif" text="#000000">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td>&nbsp;</td>
            <td><a href="../a/todo/novotodo.php?novo=1">NOVO</a></td>
          </tr>
          <tr> 
...
?>
                <tr <?=$cor?>> 
                  ...
                  <td width="3%" align="center"><a href="javascript:document.form1.id.value='<?=$linha->id?>';deleta('<?=$linha->descricao?>')"><img src="../a/imagens/deletar.gif" width="15" height="15" border="0"></a></td>
                  <td width="3%" align="center"> <a href="../a/todo/novotodo.php?id=<?=$linha->id?>"><img src="../a/imagens/alterar.gif" width="15" height="15" border="0"></a></td>
