...
include_once ('cabeca.inc.php');
     ...
     where month(data) = '11' and year(data) = $ano and evento = 'FOLHA DE PAGAMENTO' and flagTipo = '1'  ";
     ...
     where month(data) = '12' and year(data) = $ano and evento = 'FOLHA DE PAGAMENTO' and flagTipo = '1'  ";
     ...
     where month(data) = '11' and year(data) = $ano and evento = 'PONTO ELETRÔNICO' and flagTipo = '1'  ";
     ...
     where month(data) = '12' and year(data) = $ano and evento = 'PONTO ELETRÔNICO' and flagTipo = '1'  ";
	 ...
	 TRABALHISTAS' , 'ORÇAMENTO PESSOAL' , 'COMPETÊNCIAS' , 'DESEMPENHO E CARREIRA') and flagTipo = '1'  ";
...
<body bgcolor="#FFFFFF">
<div align="center"> 
  <p>Relat&oacute;rio totalizador por Colaboradores </p>
          ...
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF">
	          ...
	          <div align="center" class="style11">
				...
				<form name="form" method="post" action="reltotalunoint.php" id="form">
