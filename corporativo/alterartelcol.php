...
<title>Alteração / Inclusão de telefone de colaborador</title>
<!-- #EndEditable --> 
...
?>
              ...
              <p class="Titulo" align="center"><a href="/corporativo/index.php">Corporativo</a> : <?echo $action?> de Telefone de Colaborador</p>
              <p> <?
 ...
 if ($id) {
   ...
   $sSQL = "select *, MONTH(nasc) as mes, dayofmonth(nasc) as dia, YEAR(nasc) as ano from TelCol where id = $id;"; 
...
?> </p>
              <form name="form" action="tel_cadastro.php" method="post" >
<script language="JavaScript">
function confirma() {
  ...
  if (confirm('Tem certeza que deseja excluir os dados ?')) {
	...
	document.form.submit();
                ...
                <table width="95%" border="0" align="center">
                  <tr> 
                    <td colspan="2"> 
                      <div align="center"><a name="colaborador"></a>Utilize esta 
                        &aacute;rea para cadastrar um <b>Telefone de Colaborador</b></div>                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                  ...
                  <tr> 
                    <td width="23%"> 
                      <div align="right">Divis&atilde;o : </div>                    </td>
                    <td width="77%"> <?echo $divisao?> 
                      
                      <input type="checkbox" name="alterar" value="1" <? if (!$id) {echo "checked";};?>>
                      Alterar para : 
                      <select name="divisao">
                        <option><? echo $divisao; ?></option>
                        <option selected>ADMINISTRATIVA</option>
                        <option>CONSULTORIA</option>
                        <option>DIRETORIA</option>
                        <option>ENGENHARIA DE SOFTWARE</option>
                        <option>EST&Aacute;GIO</option>
                        <option>INTERSYSTEM</option>
                        ...
                        <option>TALENTOS HUMANOS</option>
                  ...
                  <tr> 
                    <td width="23%">
                      <div align="right"> Nome curto : </div>                    </td>
                    <td width="77%">
                      <input type="text" name="nomecurto" size="25" maxlength="25" value ="<?echo $nomecurto?>">                    </td>
                  </tr>
                  <tr>
                    <td width="23%">
                      <div align="right">Data Nasc. : </div>                    </td>
                    <td width="77%">
                      <input type="text" name="dia" size="2" maxlength="2" value="<?echo $dia?>">
                      /
                      <input type="text" name="mes" size="2" maxlength="2" value="<?echo $mes?>">
                      /
                      <input type="text" name="ano" size="4" maxlength="4" value="<?echo $ano?>">                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                      <div align="right">Residencial : </div>                    </td>
                    <td width="77%"> 
                      <input type="text" name="residencial" size="50" value="<?echo $residencial ?>">                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                      <div align="right">Celular : </div>                    </td>
                    <td width="77%"> 
                      <input type="text" name="celular" size="50" value="<? echo $celular?>">                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                      <div align="right">Home Page</div>                    </td>
                    <td width="77%"> 
                      <input type="text" name="homepage" size="50" value="<?echo $homepage?>">                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="ramal" value="<?echo $ramal ?>">                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                      <div align="right">Inativo : </div>                    </td>
                    <td width="77%"><input name="ativo" type="checkbox" id="ativo" value="0" <? if (!$id) {echo "unchecked";};?>></td>
                  </tr>
                  <tr> 
                    <td width="23%">&nbsp;</td>
                    <td width="77%"> 
                      <input type=button onClick="javascript:confirma()" value="Gravar">
                     <input name="button" type=button onClick="javascript:excluir()" value="Excluir">
					   <input type="hidden" name="acao" value="">
                      <input type="hidden" name="tipo" value="col">
                      <input type="hidden" name="id" value="<?echo $id?>">
                    <input type="hidden" name="divisaooriginal" value="<?echo $divisao?>">                    </td>
                  </tr>
                </table>
              </form>
              <p>&nbsp;</p>
