...
<?
	...
	if ($status == 1) {
		...
		linha($Area, $DataRecebimentoFinal, "<b>Encerrado</b>", "$qt $msgInteracao:<br>última em $DataAnterior");		
	} else 
	{
		linha($Area, $DataRecebimentoFinal, "<b>Em andamento</b>", "$qt $msgInteracao:<br>última em $DataAnterior");
	}
?>
