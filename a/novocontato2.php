...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="coolBar">
  <tr align="center"> 
    ...
    <td width="129" class="coolButton"><a href="/agenda/" target="_blank">Agenda</a></td>
    <td width="129" class="coolButton"><a href="../index.php" target="_blank">Intranet</a></td>
  </tr>
</table>
<hr size="1" noshade>
<div align="center"> 
...
<br>
              ...
              <input name="userfile[]" type="file" class="borda_fina" size="50" multiple="multiple" >              
              <div id="additionalEmails"></div>			  
              <input name="button" type="button" class="borda_fina" id="addFieldButton"  value="Anexar + Arquivo" > <input type="hidden" name="MAX_FILE_SIZE" value="99999999">	<br>    
              <? 
			    $checked = "";
...
//<![CDATA[
	...
	CKEDITOR.replace( 'historico',
		{
			extraPlugins: 'colorbutton,justify,smiley',
