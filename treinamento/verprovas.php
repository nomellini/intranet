...
include_once ('cabeca.inc.php');
 ...
 if ($cod_perguntas) 
     $sSQL = "SELECT  * FROM provas where cod_perguntas like '%$cod_perguntas%' order by $ordem, cod_perguntas ;";
 else
     $sSQL = "SELECT  * FROM provas order by $ordem, cod_perguntas ;";
        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" --> 
             <div align="center"><span class="style3 style4 style8 style6"><strong>Lista de Provas </strong></span></div>
                     ...
                     <tr>
                       <td width="100%">
                           ...
                           <table border="1" cellpadding="1" width="100%" cellspacing="1">
                             <tr bgcolor="#FFFFFF">
                               <td width="21%" bgcolor="#006699"><a href="verprovas.php?ordem=id" class="style1 style4"><strong>C&oacute;digo da prova </strong></a></td>
                               <td width="79%" bgcolor="#006699"><span class="style1 style4"><strong>Descri&ccedil;&atilde;o da Prova </strong></span></td>
                             </tr>
                             <?
...
?>
                             <tr>
                               <td width="21%"><span class="style4"><?echo "<a href=resultprovas.php?id=$id>$id</a>"?></span> </td>
                               <td><span class="style4"><?echo "<a href=resultprovas.php?id=$id>$descricao</a>"?></span> </td>
                             </tr>
                             <?
  };
 ?>
