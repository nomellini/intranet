...
//    print $sql;
	...
	if (($this->id_contato % 50)==0) {
      ...
      $teste = `zip /home/http/httpd/backup/backupdiario.zip /home/http/httpd/backup/atendimento_bkp.txt`;
      $teste = `rm /home/http/httpd/backup/atendimento_bkp.txt -f`;
	  $teste = `cp /home/http/httpd/backup/backupdiario.zip /home/samba/backupdiario.zip`;
      ...
      fclose( $arq );
		...
		--		
		O arquivo pode ser encontrado na pasta \\\\10.98.0.5\\public\\
		---
