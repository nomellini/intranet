...
<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#003366">
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <?php do { ?>
      <tr>
        <td><a href="mailto:<?php echo $row_rsPessoas['email']; ?>?subject=Chamado <?= $id_chamado?>"> <?php echo $row_rsPessoas['nome']; ?> </a></td>
        <td><a href="mailto:<?php echo $row_rsPessoas['email']; ?>?subject=Chamado <?= $id_chamado?>"> <?php echo $row_rsPessoas['email']; ?></a></td>
      </tr>
