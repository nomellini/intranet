...
<title>Inclusão de título</title>
<!-- #EndEditable --> 
...
<div align="center"> 
 ...
 $sSQL = "SELECT  * FROM so order by so;"; 
 $result = mysql_query($sSQL);    
?> 
              <blockquote> 
                <p>Novo t&iacute;tulo ou novo problema. Entre com o t&iacute;tulo 
                  do erro ou do problema, o sistema operacional e uma descri&ccedil;&atilde;o 
                  do porblema. Em sequinda voc&ecirc; poder&aacute; entrar com 
                  as causas e solu&ccedil;&otilde;es. </p>
              </blockquote>
              <form method="post" action="novo01.php">
                <p> 
                <blockquote> 
                  <p>Selecione o Sistema Operacional<br>
                    <font size="1"></font><br>
                    <select name="so">
<?
...
?>
                  ...
                  <p>Digite o titulo do problema:<br>
                    <input type="text" name="titulo" size="60" maxlength="150">
                    <br>
                  </p>
                  <p>Uma breve descri&ccedil;&atilde;o ou observa&ccedil;&atilde;o<br>
                    <textarea name="obs" cols="60" rows="5"></textarea>
                    <br>
                    <br>
