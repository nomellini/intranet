  ...
  <tr>
    <td><form method="post" action="veravalia2.php">
      ...
      <table width="100%" border="1" align="left">
        <tr bgcolor="#D7FFFF">
          <td align="center" valign="middle" bgcolor="#006699"><span class="style1 style4 style9"><strong>Procure pelo nome do treinando </strong></span></td>
          </tr>
        <tr>
          <td align="center" valign="middle" bgcolor="#DBF0EE"><span class="style5"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Nome </font>
              <input name="nome" type="text" id="nome" size="60" />          
              </span>            <input name="Submit" type="submit" value="procura" />          </td>
          </tr>
      </table>
    </form></td>
  </tr>
