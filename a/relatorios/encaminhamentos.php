...
<form name="form" method="post" action="encaminhamentos.php">
...
[<a href="javascript:document.form.datai.value='<?=$hoje?>';document.form.dataf.value='<?=$hoje?>';document.form.submit();">hoje</a> ] ,</td>
          ...
          <tr>
            ...
            <td><select name="sistema" class="bordaTexto">
              <option value="0">Todos</option>
              <?  
...
?>
          ...
          <tr>
            ...
            <input name="palavra" type="text" class="bordaTexto" id="palavra" size="50"></td>
          </tr>
        </table>        
    ...
    <td colspan="4" align="left" height="19"> 
      <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#FFFFFF">
        <tr bgcolor="#FCE9BC">
          ...
          <td height="17" align="center"><?=$tmp["dataa"]?></td>
