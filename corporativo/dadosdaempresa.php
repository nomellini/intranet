          ...
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" --> 
              ...
              <p align="center" class="Titulo"><a href="/corporativo/index.php">Corporativo</a> 
                : Dados da Empresa</p>
              <table width="95%" border="0" align="center" bordercolorlight="#CC6600" bordercolordark="#CC6600" class="bgTabela" cellspacing="1" cellpadding="0">
                <tr bordercolor="#CC6600" bgcolor="#CC6600"> 
                  <td colspan="2" class="TabelaRotulo"> <div align="center"><font color="#FFFFFF"
face="Arial" size="-1"><b>Dados da Empresa</b></font></div></td>
                </tr>
                <tr bordercolor="#CC6600" bgcolor="#CC6600"> 
                  <td valign="TOP" width="164" class="TabelaPadrao"> <div align="right">Raz&atilde;o 
                      Social : </div></td>
                  <td valign="TOP" width="409" class="TabelaPadrao"><b> Datamace 
                    Inform&aacute;tica Ltda. </b></td>
                </tr>
                <tr bordercolor="#CC6600" bgcolor="#CC6600"> 
                  <td valign="TOP" width="164" class="TabelaPadrao"> <div align="right">Endere&ccedil;o :</div></td>
                  <td valign="TOP" width="409" class="TabelaPadrao"> Rua Pedro Setti, 221 - 
                    Vila Olga- S&atilde;o Bernardo do Campo - SP <br>
                    CEP 09720-370</td>
                </tr>
                <tr bordercolor="#CC6600" bgcolor="#CC6600"> 
                  <td valign="TOP" width="164" class="TabelaPadrao"> <div align="right">Fones :</div></td>
                  <td valign="TOP" width="409" class="TabelaPadrao">&nbsp;</td>
                </tr>
                <tr bordercolor="#CC6600" bgcolor="#CC6600"> 
                  <td valign="TOP" width="164" class="TabelaPadrao"> <div align="right">Fax Recep&ccedil;&atilde;o
                      : </div></td>
                  <td valign="TOP" width="409" class="TabelaPadrao">&nbsp;</td>
                </tr>
                <tr bordercolor="#CC6600" bgcolor="#CC6600">
                  <td valign="TOP" width="164" class="TabelaPadrao"><div align="right">Fax Administra&ccedil;&atilde;o : </div></td>
                  <td valign="TOP" class="TabelaPadrao">&nbsp;</td>
                </tr>
                <tr bordercolor="#CC6600" bgcolor="#CC6600"> 
                  <td valign="TOP" width="164" class="TabelaPadrao"> <div align="right">CNPJ 
                      : </div></td>
                  <td valign="TOP" width="409" class="TabelaPadrao">57.195.497/0001-68 
                  </td>
                </tr>
                <tr bordercolor="#CC6600" bgcolor="#CC6600"> 
                  <td valign="TOP" width="164" class="TabelaPadrao"> <div align="right">I.E. 
                      : </div></td>
                  <td valign="TOP" width="409" class="TabelaPadrao">635.159.720.111 
                  </td>
                </tr>
                <tr bordercolor="#CC6600" bgcolor="#CC6600"> 
                  <td valign="TOP" width="164" class="TabelaPadrao"> 
                    <div align="right">Site: </div></td>
                  <td valign="TOP" width="409" class="TabelaPadrao"><a
href="http://www.datamace.com.br">http://www.datamace.com.br</a></td>
                </tr>
              </table>
              <p align="center">&nbsp;</p>
              <!-- #EndEditable --></td>
