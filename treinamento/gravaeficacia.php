...
include('cabeca.inc.php');
 ...
 if ($id) {
   ...
   if (!$result = mysql_query($sSQL)) {
    ...
    $texto_email_html = "Prezado Gestor, <br><br> Identificamos a participação de seu colaborador $treinando no treinamento $titulo realizado em $data1. <br><br> Solicitamos, por gentileza, que seja avaliada a eficácia deste treinamento através do link abaixo.<br><br>Grato<br>Depto. de Talentos Humanos<br><br>" .
      ...
      <td><table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF">
				<div align="center">Clique <a href="/treinamento/eficacia.php">aqui</a> para incluir uma nova avaliação de efiácia.</div>
				<br>
				<br>
