<?
	...
	/*
	   Qualquer altera��o aqui deve ser feita em Historico.PHP, pois o c�digo  � o mesmo
	*/
...
<br>
<br>
<a href="javascript:alterna(divRestricoes);">&nbsp;&nbsp;&nbsp; +Restri��es</a>
...
<?
   /* op��o para marcar como n�o lido - Inicio  */
	if ( ($ok == $destinatario_id) )
	{
?>
<form name="ligaLampada"><input type="hidden" value="1" name="ligarLampada"><input type="hidden" value="<?=$id_chamado?>" name="id_chamado"><a href="javascript:document.ligaLampada.submit();">Marcar como n�o lido</a></form>
<?
   }
   /* op��o para marcar como n�o lido - fim */
?>
...
?>
  ...
  <tr>
	...
	<? if ($developer) {?>
	    <td bordercolor="#FFFFFF" bgcolor="#0066FF"><span class="style8">A��o</span></td>
	<? }?>
  </tr>
...
?>
      ...
      <td align="right"><input type="submit" name="Submit22" value="Novo Chamado" class="NovoContato" onClick="javascript:document.form.action.value='chamado';vai();"></td>
    </tr>
  </table>
  <br>
</div>
...
<table width="98%" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr valign="middle" align="left">
    ...
    <td width="42%" align="right"><input type="submit" name="Submit2" value="Novo Chamado" class="NovoContato" onClick="javascript:document.form.action.value='chamado';vai();"></td>
  </tr>
  <tr valign="middle" align="left">
...
//	  return;
 ...
 ?>
	...
	contatos.innerHTML = '<?php echo "$UltimoContato contato$ss consumindo $dd - dura��o : " . segTohora($segundos);?>';
