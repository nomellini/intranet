...
<? 
 ...
 if ($acao=="excluir") {
	...
	$sSQL = "DELETE from escolaridade WHERE id = $id;";
    mysql_query($sSQL);
	$acao = "excluído";
 } else {
...
$nome = strtoupper($nome); 
      $sSQL = "INSERT into escolaridade (area, nome, grau) VALUES ('$area','$nome', '$grau');";
   ...
   $nome = strtoupper($nome);    
      $sSQL = "UPDATE escolaridade SET area='$area', nome='$nome', grau='$grau' WHERE id = $id; ";
          mysql_query($sSQL);
 ...
 ?>
              ...
              <p><b> <? echo "$nome foi $acao" ?></b> com sucesso !<br>
                <br>
                <br>
                Clique <a href="/corporativo/alterarescolaridade.php">aqui</a> para 
                cadastrar mais um, ou<br>
                Clique <a href="/corporativo/escolaridade.php">aqui</a> para ver 
                os colaboradores cadastrados.</p>
