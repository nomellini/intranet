...
include_once ('cabeca.inc.php');
 ...
 if ($nome) 
     $sSQL = "SELECT * FROM cadastrotreinamento  where `identifica` = 'DATAMACE' and nome like '%$nome%' order by $ordem, nome ";
	else
     $sSQL = "SELECT * FROM cadastrotreinamento where identifica = 'DATAMACE' order by $ordem, nome ";
        ...
        <td width="100%">
          ...
          <table border="1" cellpadding="1" width="100%" cellspacing="1">
                <tr bgcolor="#FFFFFF" class="TabelaRotulo">
                  <td width="43%" bgcolor="#006699"><a href="vercadtreDTM.php?ordem=empnome" class="style1">Nome da empresa </a></td>
                  <td width="42%" bgcolor="#006699"><a href="vercadtreDTM.php?ordem=nome" class="style1">Nome do treinando </a></td>
                  <td width="15%" bgcolor="#006699"><a href="vercadtreDTM.php?ordem=hoje" class="style1">Data</a></td>
                </tr>
                <?
