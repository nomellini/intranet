...
include_once ('cabeca.inc.php');
 ...
 $sSQL = "SELECT  * FROM provas where id = $id;";
 $result = mysql_query($sSQL);   
   
 while ($linha = mysql_fetch_object($result)) {
      $id = $linha->id;
      $descricao = $linha->descricao;
	  $cod_perguntas = $linha->cod_perguntas;
	  $cod_perguntas = str_replace("#",'&nbsp;', $linha->cod_perguntas); // transforma campo string em tabela (array)
?>
...
-->
  ...
  <span class="style16">Lista de Provas </span>
</div>
<p>&nbsp;</p>
...
for ($x=0;$x < $tot_perguntas;$x++) {
       ...
       $sSQL = "select * from perguntas where id = $cod_perguntas[$x];"; 
       if (!$result = mysql_query($sSQL)) {
           echo "<br><br>Problema na tabela de provas</b><br>";
       };
       if (!$linha = mysql_fetch_object($result)) {
          echo "<br><br>Prova $cod_perguntas[$x] não cadastrado.</b><br>";
       };
       $cod_perguntas = $linha->id; 
       $descricao = $linha->descricao; 
   }    
...
?>
  ...
  <tr bgcolor="#006699">
    <td width="15%" height="22"><div align="left" class="style17 style1 style7 style7"><strong><span class="style6 style5"><strong>C&oacute;digo</strong></span></strong></div></td>
    <td height="22"><span class="style15"><span class="style1 style7 style7"><strong>Descri&ccedil;&atilde;o</strong></span></span></td>
    </tr>
  <tr>
    <td width="15%"><span class="style3 style7 style7"><? echo $id ?></span></td>
    <td><span class="style3 style7 style7"><? echo $descricao ?></span></td>
    </tr>
  <tr>
    <td colspan="2" bgcolor="#006699"><strong><span class="style4 style5 style1 style7">Perguntas</span></strong></td>
    </tr>
  <tr>
    <td colspan="2"><span class="style3 style7 style7"><? echo $cod_perguntas ?></span></td>
    </tr>
    <?
  };
 ?>
