...
<? 
 ...
 if ($acao == "excluir") {
    $sSQL = "DELETE from emaildtm WHERE id = '$id' ;";
    mysql_query($sSQL);
   $acao = "excluído";
 } else {
 ...
 if (!$id) {
   ...
   $acao = "incluído";
      ...
      $sSQL = "INSERT into emaildtm (nome, email, empresa) VALUES ('$nome', '$email', '$empresa');"; 
   ...
   if (!$alterar) {
     $divisao = $divisaooriginal;
      ...
      $sSQL = "UPDATE emaildtm SET nome='$nome', email='$email', empresa='$empresa' WHERE id = $id;";
      mysql_query($sSQL);
 ...
 ?>
              ...
              <p><b> <? echo "$nome foi $acao" ?></b> com sucesso !<br>
                <br>
                Clique <a href="/Apoio/alteraremaildtm.php">aqui</a> para cadastrar mais um e-mail, ou <br>
