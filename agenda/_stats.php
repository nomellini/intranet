<?
  ...
  DayOfWeek(Data) dia,
  Count(1) qtde,
  (select count(1) from relax r2 where dayofweek(r2.data) = dayofweek(r.data) and hour(r2.hora) < 14 and Data >= '2016-01-01') as manha,
  (select count(1) from relax r3 where dayofweek(r3.data) = dayofweek(r.data) and hour(r3.hora) >=14 and Data >= '2016-01-01') as tarde
FROM relax r
...
if (($ok == 143) |($ok == 12)) {
	$sql = "select
  u.nome,
  (select count(1) from relax r2 where r2.id_usuario = r.id_usuario and presente = 0 and Data >= '2016-01-01') as f,
  (select count(1) from relax r3 where r3.id_usuario = r.id_usuario and presente = 1 and Data >= '2016-01-01') as c,
  count(1) as t
from
  relax r
