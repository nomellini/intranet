...
<title>Altera&ccedil;&atilde;o / Inclus&atilde;o de Informa&ccedil;oes para Assist&ecirc;ncia M&eacute;dica</title>
<!-- #EndEditable --> 
...
?>
              ...
              <p class="Titulo" align="center"><a href="/corporativo/index.php">Corporativo</a> : <?echo $action?> Informa&ccedil;&atilde;oes </p>
              <p> <?
  ...
  if (confirm('Tem certeza que deseja excluir os dados ?')) {
	...
	document.form.submit();
                ...
                <table width="95%" border="0" align="center">
                  ...
                  <tr> 
                    <td width="23%"> 
                      <div align="right">Descri&ccedil;&atilde;o :</div>
                    </td>
                    <td width="77%"> 
                      <input name="descricao" type="text" value="<?echo $descricao?>" size="50" >
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%">&nbsp;</td>
