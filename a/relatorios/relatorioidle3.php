...
//	$origem = 1;	
	$ch = statIdleDeAte($consultor, $datar, $dataf, $origem);	
	$total = count($ch);
...
<form name="form" method="post" action="relatorioidle3.php">
...
<?  
    ...
    $consultores = pegaSoConsultores($atendimento);		
...
?>
        ...
        At&eacute; 
        <input type="text" name="dataAte" size="12" maxlength="12" class="unnamed1" value="<?=$dataAte?>">
tipo
...
?>
		...
		<td width="10%" height="16" align="center">       <?= SegToHora($idleAcc) ?></td>
		</tr>
<?
        $idleAcc = 0;
		$seg = 0;
...
?>
  <tr bgcolor="#FCE9BC" align="center" valign="middle"> 
    ...
    <td width="10%" height="16" align="center">  <?= SegToHora($seg); $idleAcc += $seg; ?>  - <?= SegToHora($idleAcc) ?> </td>      
  </tr>
  <? }
	  $ha = $horae; 
	  $data_old = $data; 
