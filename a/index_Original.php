  ...
  <tr> 
    <td valign="top" > 
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr> 
          <td width="50%"><img src="../imagens/logotipo%20datamace.gif" width="155" height="46"></td>
        ...
        <form name="form" method="post" action="index.php">
          ...
          <table width="60%" border="0" cellspacing="1" cellpadding="1" align="center">
            ...
            <tr> 
              ...
              <span class="textfieldRequiredMsg">Campo login é obrigatório<br></span>
              <input type="text" name="email" size="50" maxlength="150" value="<?=$cookieEmailUsuario?>" class="unnamed1" >
              </span></td>
            </tr>
            <tr> 
              <td width="23%">Senha</td>
              <td width="77%"><span id="sprytextfield2">
              <span class="textfieldRequiredMsg">Campo senha obrigatório<br></span>              
