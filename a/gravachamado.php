...
/*	foreach($id_restricao as $IdRestricao)
	...
	/**********************************************************************************
		Contato automático inserido pelo sistema (P�blico)
...
<p class=\"style1\">Consultoria Datamace</p>
	...
	/*
	 O Chamado ja foi criado no início da página chamado.php
	 Ao criar o chamado, ja foi definido o dono do chamado, as linhas
