	...
	<table width="100%" border="0">
     ...
     document.write (diasemana[diaindex] + '<br>' + dia + ' de ' + mesescrito[mes] + ' de ' + ano);
				...
				<table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
					<tr>
						<td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0">
							<tr>
								<td>&nbsp;</td>
						    </tr>
						  </table>
							<p class="TituloTreino" align="center">Relat&oacute;rio de Quantidade de Avalia&ccedil;&otilde;es do Treinamento</p>							<table width="80%" border="0" align="center">
								<tr>
									<td><form action="<?=$PAGINA ?>" method="post" name="form" id="form">
											...
											<table width="100%" border="1" align="left">
												...
												<tr>
													<td id="e_evento">M&oacute;dulo :</td>
        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" -->
							...
							<p class="TituloTreino" align="center">Relat&oacute;rio de Quantidade de Avalia&ccedil;&otilde;es do Treinamento</p>
