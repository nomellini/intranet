		  ...
		  while ( list($tmp1, $tmp) = each($chamadosemaberto) ) {
			   ...
			   $rncMensagem = '';
				if ($tmp["rnc"]!=0) {
					...
					$rncMensagem = "<br>--> ".$rncTipo."<br>Departamento respons�vel: <strong>$rncResponsavel</strong>. Prazo: <strong>$rncPrazo</strong>";
				}
...
<a href="preferencias.php?ok=<?=$ok?>">Personalizar meu desktop<br>
        ...
        <font size="2">Ver Chamados Encaminhados e Pend�ncias</font></a><br>
...
contaencaminhados.innerHTML = '<?=$contaencaminhados?>';
 ...
 if( <?=$msgnova?> ) {
   msgnova.innerHTML = "<br>Existe <?=$msgnova?> chamado(s) com mensagens n�o lidas (<img src=figuras/idea01.gif  align=absmiddle>)";
 }
