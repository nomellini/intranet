...
if (x == 1) {
var resp = "Aqui você abre um chamado para reportar um erro<br>ou acompanha um chamado.";
}

else if (x == 2) {
var resp = "Aqui você envia um arquivo para<br>um chamado existente.";
}

else if (x == 3) {
var resp = "Aqui você visualiza os<br>usuários cadastrados.";
}

else if (x == 4) {
var resp = "Aqui você acompanha o calendário.";
}

else if (x == 5) {
var resp = "Aqui você visualiza a estatística.";
}

else if (x == 6) {
var resp = "Aqui você abre um chamado.";
}

else if (x == 7) {
var resp = "Aqui você acompanha um chamado.";
}

else if (x == 8) {
var resp = "Aqui você acompanha os chamados encerrados.";
}
...
<script type="text/javascript">
		<!--
	d = new dTree('d');
		d.add(1,-1,'  Pastas do SAD  <img src="http://intranet.datamace.com.br/sad/img/icone_menu_principal.gif"><Br><img src="http://intranet.datamace.com.br/sad/img/line.gif">');
		...
		d.add(7,1,'<a onmousemove=mouseover("3"); onMouseOut=mouseout(); href="usuarios_treinados.php"> Usuários Cadastrados <img src="img/icone_menu_usuarioscadastrados.gif"/></a>');
