...
include_once ('cabeca.inc.php');
 ...
 if ($nome) 
     $sSQL = "SELECT * FROM cadastrotreinamento  where `identifica` = 'PARCEIROS' and nome like '%$nome%' order by $ordem, nome ";
	 
	else
     $sSQL = "SELECT * FROM cadastrotreinamento where identifica = 'PARCEIROS' order by $ordem, nome ";
...
<div align="center">
  ...
  <tr>
    <td>
	<form action="vercadtre.php" method="post" class="style13">
    ...
    <td width="100%"><table border="0" cellpadding="0" width="100%">
      <tr>
        <td width="100%">
          ...
          <span class="style6 style6 style6">Treinamento realizado por:</span><span class="style6 style6"> <a href="vercadtreDTM.php">Datamace</a> - <a href="vercadtrePAR.php">Parceiros</a> - <a href="vercadtre.php">Todos</a></span><br>
          <table border="1" cellpadding="1" width="100%" cellspacing="1">
                <tr bgcolor="#FFFFFF" class="TabelaRotulo">
                  <td width="43%" bgcolor="#006699"><a href="vercadtrePAR.php?ordem=empnome" class="style1">Nome da empresa </a></td>
                  <td width="42%" bgcolor="#006699"><a href="vercadtrePAR.php?ordem=nome" class="style1">Nome do treinando </a></td>
                  <td width="15%" bgcolor="#006699"><a href="vercadtrePAR.php?ordem=hoje" class="style1">Data</a></td>
                </tr>
                <?
