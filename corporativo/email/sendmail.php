...
<div align="center"><FONT face="Verdana, Arial, Helvetica, sans-serif" size=3><A 
href="../../index.php">Home</A></FONT><br>
    <br>
    <?
   /* recipients */
$recipient .= $email_to;
...
$headers .= "From: $email_from_nome <$email_from_email>\n";
...
if (mail($recipient, $subject, $message, $headers)) {
  ...
  echo ("Email não foi enviado. Tente novamente mais tarde");
}
