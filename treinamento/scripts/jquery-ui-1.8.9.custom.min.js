...
(function (c, j) {
	...
	c.widget("ui.dialog", {
		options: {
			showTitle: true,
			handleName: "",
			bgTransp: true, /*Usado para deixar o background do dialog transparente - default = false*/
			autoOpen: true,
			buttons: {},
			customClose: true, /*Usado para exibir o botão close sem precisar implementa-lo na tela(novo PopUp) - defaut = true*/
			closeOnEscape: true,
			closeText: "close",
			dialogClass: "",
			draggable: true,
		...
		_create: function () {
			...
			if (b.customClose){
				TSBotaoFechar = $('<a href="#" />')
				.addClass('TS-dialog-close-style')
				.click(function(event) {
					a.close(event);
					return false;
				});
				TSBotaoFechar.appendTo(g);
			};

			f.find("*").add(f).disableSelection();
			if (b.handleName != ''){
				$(".ui-dialog").draggable({ handle: b.handleName });
				/*Setando false antes de aplicar o _makeDraggable(), assim não precisa setar */
				/*essa propriedade quando usamos o handleName*/
				b.draggable = false;
            }
			...
			if (b.bgTransp){
				this.uiDialog.removeClass('ui-widget-content');
			}
			if (!b.showTitle) {
...
(function (d, G) {
	function K() {
		...
		this._defaults = {
			...
			buttonImage: "imagens/DataPicker.png",
