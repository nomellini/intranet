...
<div align="center"> 
        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            ...
            <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
              ...
              <p align="center">&nbsp;</p>
              <p align="center"><font color="#666666" face="Verdana, Arial, Helvetica, sans-serif" class="Titulo">Ramais Internos (Cadastro pelo SAD)</font></p>
 ...
 mysql_select_db(sad);
 if ($ordem=="") { $ordem="nome";};
// $sSQL = "SELECT  * FROM ramal order by nome;"; 
 $sSQL = "SELECT nome, email, ramal FROM usuario WHERE ativo and ramal is not null ORDER BY nome ASC";
...
?>
 ...
 ?>
              ...
              <p align="center">&nbsp; </p>
              <p>&nbsp;</p>
              <table border="0" cellpadding="0" cellspacing="1" width="95%" ="#FF9933" align="center" class="bgTabela">
              </table>
              <p>&nbsp;</p>
