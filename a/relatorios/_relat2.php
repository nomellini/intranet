 ...
 ?>
  ...
  size="12" maxlength="10" value="<?=$datai?>" onKeyPress="fdata(this)">
    ...
    <tr bgcolor="#FCE9BC">
      ...
      <td width="27%"><select name="categoria" class="bordaTexto">
          <option value="0">Todos</option>
          <?  
...
?>
      ...
      <td width="51%"><select name="status" class="bordaTexto">
          <option value="0">Todos</option>
          <?  
...
?>
    ...
    <tr bgcolor="#FCE9BC">
      <td width="14%">Tipo</td>
      <td width="27%"><select name="tipo" class="bordaTexto">
          <option value="0">Todos</option>
          <?  
...
?>
      ...
      <td width="51%"><select name="motivo" class="bordaTexto">
          <option value="0">Todos</option>
          <?  
...
?>
    ...
    <tr bgcolor="#FCE9BC">
      <td>Sistema</td>
      <td colspan="3"><select name="sistema" class="bordaTexto">
          <option value="0">Todos</option>
          <?  
