...
<title>Altera&ccedil;&atilde;o / Inclus&atilde;o de e-mails</title>
<!-- #EndEditable --> 
...
?>
              ...
              <p class="Titulo" align="center"><a href="/corporativo/index.php">Corporativo</a> : <?echo $action?> de Emails</p>
              <p> <?
 ...
 if ($id) {
   ...
   $sSQL = "select * from emaildtm where id = $id;"; 
  ...
  $sel_empresa[$empresa] = "selected";
 }

?> </p>
              <form name="form" action="email_cadastrodtm.php" method="post" >
<script language="JavaScript">
function confirma() {
	...
	document.form.submit();
                ...
                <table width="95%" border="0" align="center">
                  <tr> 
                    <td colspan="2"> 
                      <div align="center"><a name="colaborador"></a>Utilize esta 
                        &aacute;rea para cadastrar um <b>e-mail</b></div>
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                  ...
                  <tr> 
                    ...
                    <td width="77%"> 
                      <input name="email" type="text" id="email" value="<?echo $email?>" size="50">
                    </td>
                  </tr>
                  <tr>
                    <td><div align="right">empresa : </div></td>
                    <td><select name="empresa" id="empresa">
                      <option value="1" selected <? echo $sel_empresa[1] ?>>Datamace</option>
                      <option value="2" <? echo $sel_empresa[2] ?>>Dipraxis</option>
                      <option value="3" <? echo $sel_empresa[3] ?>>Intersystem</option>
                    </select></td>
                  </tr>
                  <tr> 
                    <td width="23%">&nbsp;</td>
