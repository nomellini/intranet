...
/*
  ...
  Data Cria��o : 29/01/2005

  Data das
  Altera��es   : 08/02/2005

  Obs :
  Dever� ser criada uma tabela para indicar o status do cliente,
  se ele est� em p�s-venda ou n�o. N�o devo criar um campo na tabela de clientes,
  pois a tabela de clientes � recriada constantemente pelo DIP e com isso qualquer
  informa��o que o sad alterar nesta tabela seria sobreposta.

  N�o � poss�vel analisar o status do p�s-venda somente olhando se tem um chamado
  p�s-venda, pois, se eu n�o permitir abrir um novo chamado com cliente em p�s-venda,
  e se esta verifica��o � feita vendo se tem um chamado de p�s-venda, ent�o,
  o cliente nunca sair� do p�s-venda, pois nunca iria se conseguir abrir um novo
  chamado para sair do p�s-venda.

  Deve-se portanto, se criar uma tela em que seja poss�vel alterar o status
  do cliente para indicar se o mesmo est� ou n�o em P�s-venda. Caso o cliente
  estiver em p�s-venda, s� ser� poss�vel abrir chamado pela administra��o

  Quando o cliente for definido como fora do p�s-venda, os chamados ser�o liberados para
  abertura.

  A Tabela ClientePlus cont�m um campo chamado fl_posvenda boolean

  Todo registro da tabela cliente deve ter um correspondente na tabela ClientePlus.
  Um bom lugar para verificar isso � em /a/manut/backup.php, logo ap�s a importa��o dos clientes.
  ...
  10 - Cliente Novo
  0 - Fora de p�s venda.
  1 - Cliente em p�s venda

  data_inicio = Data em que o cliente foi inclu�do no sistema
  data_inicioposvenda - Data em que o cliente foi inclupido no p�s venda
  data_fimposvenda - Data em que o cliente foi retirado do p�s venda
...
<br>
<table width="80%"  border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC" id="tblClientes" summary="Tabela que mostra quais clientes s�o novos. Pede para determinar quais deles ser�o p�s-venda e quais n�o ser�o.">
  <caption>
  Novos clientes.
  </caption>
  <tr bgcolor="#666666">
