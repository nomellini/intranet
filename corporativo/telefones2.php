        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" -->
              ...
              <p class="Titulo" align="left"><a href="#uteis">&Uacute;teis</a></p>
              <p class="Titulo" align="left"><a href="#colab"><br>
              Colaboradores</a></p>
              <p class="Titulo" align="left"><br>
                <a href="#excolab">Ex-Colaboradores<br>
                <br>
                <br>
                <br>
                <br>
...
?>
                      <tr> 
                        ...
                        <a name="<?=$id?>"></a> <a href="alterartelcol.php?id=<?=$id?>"> <?echo $nome?> </a>
                          </font></td>
...
?>
                        <tr>
                          <td width="30%" bgcolor="#c0c0c0" class="TabelaPadrao"><font size="1"><a name="<?=$id?>"></a><a href="alterartelcol.php?id=<?=$id?>"> <?echo $nome?> </a></font></td>
...
?>
                      <tr> 
                        <td width="30%" bgcolor="#c0c0c0" class="TabelaPadrao"><font size="1"> 
<a name="x<?=$id?>"></a><a href="alterartelexcol.php?id=<?=$id?>"> <?echo $nome?> </a>
                          </font></td>
