...
<? 
 ...
 if ($acao == "excluir") {
    $sSQL = "DELETE from ramal WHERE ramal = $ramal;";
    mysql_query($sSQL);
   $acao = "excluído";
 } else {
 ...
 if (!$id) {
   ...
   $acao = "incluído";
      ...
      $sSQL = "INSERT into ramal (nome, ramal, departamento) VALUES ('$nome', '$ramal', '$departamento');"; 
   ...
   if (!$alterar) {
     $divisao = $divisaooriginal;
      ...
      $sSQL = "UPDATE ramal SET nome='$nome', ramal='$ramal', departamento='$departamento' WHERE id = $id;";
      mysql_query($sSQL);
 ...
 ?>
              ...
              <p><b> <? echo "$nome foi $acao" ?></b> com sucesso !<br>
                <br>
                <br>
                Clique <a href="/corporativo/alterarramal.php">aqui</a> para 
                cadastrar mais um, ou<br>
                Clique <a href="/corporativo/ramais.php">aqui</a> para ver 
