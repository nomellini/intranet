...
if ($nome != ""){
	...
	$sSQL = "SELECT *, date_format(hoje, '%d/%m%/%Y') as hojeF FROM cadastrotreinamento ";
	if (is_numeric($nome)){
		$sSQL .= " where rg = $nome";
	}elseif ($nome){
		$sSQL .= " where nome like '%$nome%'";
	}
	$sSQL .= " order by  $ordem, nome";
				...
				<table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
					<tr>
						<td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" -->
							<form action="vermancadtre.php" method="post" name="form" id="form">
								<input name="rg" type="hidden" id="rg" value="<?=$rg ?>"/>
								...
								<table width="100%" border="0" align="center">
										<td><table width="732" border="1">
												<tr>
													<td colspan="2" class="thTreinamento">Filtros</td>
												</tr>
												<tr>
													<td width="22%" id="e_nome">Nome/RG</td>
													<td width="78%"><input name="nome" type="text" id="nome" size="60" value="<?=$nome ?>"/>
														<input name="BTNGravar" id="BTNGravar" type="button" value="Procurar" />
														(* = Todos) </td>
												</tr>
											</table></td>
									</tr>
									...
									<tr>
										<td><table id="tabela" border="1" cellpadding="1" width="732" cellspacing="1">
												<thead>
													<tr class="thTreinamento">
														<td width="43%" style="color:#FFF"><?="<a href='$PAGINA?nome=$nome&linkPagina=$linkPagina&ordem=empnome".(($ordem=="empnome") ? " desc " : "")."'>Nome da empresa</a>" ?></td>
														<td width="42%" style="color:#FFF"><?="<a href='$PAGINA?nome=$nome&linkPagina=$linkPagina&ordem=nome".(($ordem=="nome") ? " desc " : "")."'>Nome do treinando</a>" ?></td>
														<td width="15%" style="color:#FFF"><?="<a href='$PAGINA?nome=$nome&linkPagina=$linkPagina&ordem=hoje".(($ordem=="hoje") ? " desc " : "")."'>Data</a>" ?></td>
													</tr>
												</thead>
												<tbody>
													<?
...
?>
													<tr>
														<td width="43%"><?="<a href=mancadtre.php?id_opc=1&linkPagina=$linkPagina&rg=$linha->rg>$linha->empnome</a>" ?></td>
														<td><?="<a href=mancadtre.php?id_opc=1&linkPagina=$linkPagina&rg=$linha->rg>$linha->nome</a>" ?></td>
														<td align="center"><?="<a href=mancadtre.php?id_opc=1&linkPagina=$linkPagina&rg=$linha->rg>$linha->hojeF</a>" ?></td>
													</tr>
													<?
	}
}
