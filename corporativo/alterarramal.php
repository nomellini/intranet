...
<title>Altera&ccedil;&atilde;o / Inclus&atilde;o de ramais</title>
<!-- #EndEditable --> 
...
?>
              ...
              <p class="Titulo" align="center"><a href="/corporativo/index.php">Corporativo</a> : <?echo $action?> de Ramais </p>
              <p> <?
 ...
 if ($id) {
   ...
   $sSQL = "select * from ramal where id = $id;"; 
...
?> </p>
              <form name="form" action="ramal_cadastro.php" method="post" >
<script language="JavaScript">
function confirma() {
...
function excluir() {
  if (!document.form.nome.value){ 
       alert("Deve preencher o campo Nome") 
	...
	document.form.submit();
                ...
                <table width="95%" border="0" align="center">
                  <tr> 
                    <td colspan="2"> 
                      <div align="center"><a name="colaborador"></a>Utilize esta 
                        &aacute;rea para cadastrar um <b>Ramal</b></div>
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
                  ...
                  <tr> 
                    ...
                    <td width="77%"> 
                      <input name="ramal" type="text" id="ramal" value="<?echo $ramal?>" size="50">
                    </td>
                  </tr>
                  <tr> 
                    <td width="23%"> 
