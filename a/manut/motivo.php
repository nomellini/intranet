...
<?
 ...
 if ($acao=="inserir") {
   $sSQL = "INSERT INTO motivo (motivo) VALUES ('$motivo');";
   mysql_query($sSQL);   
 } else if ($acao=="deletar") {
   $sSQL = "DELETE FROM motivo where id_motivo = $id_motivo;";
   mysql_query($sSQL);
 } else if ($acao=="alterar") {
   $sSQL = "UPDATE motivo SET motivo = '$motivo' where id_motivo=$id_motivo;";
   mysql_query($sSQL);
 }
...
<p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">motivos:</font></p>
<form name="form" method="post" action="motivo.php">
  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Caso queira alterar 
    ...
    <br>
    <input type="text" name="motivo" size="30" maxlength="150" class="unnamed1">
  ...
  <table width="500" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="62%"> 
        <div align="center"><i><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000099">motivo</font></i></div>
      </td>
      <td width="28%"> 
 ...
 ?>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="28%"> 
        <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="javascript:document.form.acao.value='deletar'; document.form.id_motivo.value=<?=$id?>;deleta('<?=$nome?>');">deleta</a> 
          / <a href="javascript:document.form.acao.value='alterar'; document.form.id_motivo.value=<?=$id?>;document.form.submit();">Altera</a></font></div>
      </td>
    </tr>
    <?}?>
  </table>
  <p> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
    ...
    <input type="hidden" name="id_motivo">
