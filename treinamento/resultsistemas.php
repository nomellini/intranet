...
include_once ('cabeca.inc.php');
  ...
  $sSQL = "SELECT  * FROM sistemas where id = $id;";
  $result = mysql_query($sSQL);   


 while ($linha = mysql_fetch_object($result)) {
      $cod_sistema = $linha->id;
    ...
    <tr>
     ...
     document.write (diasemana[diaindex] + '<br>' + dia + ' de ' + mesescrito[mes] + ' de ' + ano);
        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" --><div align="center" class="style8"><strong><span class="style16 style3">    Lista de Sistemas</span></strong><br>
              <br>
            </div>
...
for ($x=0;$x < $tot_perguntas;$x++) {
	   ...
	   if (!$cod_sistemas[$x]) continue;

       $sSQL = "select * from perguntas where id = $cod_sistemas[$x];"; 
       if (!$result = mysql_query($sSQL)) {
           echo "<br><br>Problema na tabela de sistemas</b><br>";
       };
       if (!$linha = mysql_fetch_object($result)) {
          echo "<br><br>sistema $cod_sistemas[$x] não cadastrado.</b><br>";
       };
       $cod_sistemas = $linha->id; 
       $descricao = $linha->descricao; 
   }    
?>

  <tr bgcolor="#006699">
    <td width="163" height="22"><div align="left" class="style17 style8 style8"><span class="style1 style13 style5 style8 style8"><strong>C&oacute;digo do sistema</strong></span></div></td>
    <td height="22"><span class="style1 style8 style8"><strong>Descri&ccedil;&atilde;o do sistema</strong></span> </td>
  </tr>
  <tr>
    <td><span class="style12 style8 style8 style12 style8 style8"><? echo $cod_sistema ?></span></td>
    <td><span class="style12 style8 style8"><? echo $descricao ?></span></td>
  </tr>
    <?
  };
 ?>
