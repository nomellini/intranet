...
<title>Migra&ccedil;&atilde;o de ID</title>
<link href="../stilos.css" rel="stylesheet" type="text/css" />
</head>

<body>
<blockquote>
  <p><strong>Aten&ccedil;&atilde;o</strong>. Nesta tela &eacute; poss&iacute;vel migrar os Id's de um determinado cliente por outro Id, esta rotina afeta somente a tabela de chamados, onde um Id de cliente do chamado est&aacute; amarrada com um Id de cliente na tabela de clientes. Quando no DIP este ID &eacute; alterado, os chamados do cliente devem ser atualizados para refletir este novo ID.<br />
    <strong>-&gt; 
