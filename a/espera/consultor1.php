<?	
   ...
   if ($acao=='atender') {
    ...
    if ($acao == 'desligar') {
     if ($id_ligacao) {	
	   $sql = "update satligacao set id_satstatus = 4, hora_fim='$hora' where id = $id_ligacao;";
	   mysql_query($sql) or die($sql);
       header("Location: ../index.php");
	  }
	}
   ...
   $sql = '';
   $sql .= "select ";
   $sql .= "  id, cliente.cliente, cliente.senha, cliente.id_cliente, ";
...
<table width="900" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    <td> <img src="../figuras/topo_sad_e_900.jpg" width="900" height="79">      <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
...
<?
  ...
  $sql .= "id_satstatus = 4 and id_usuario=$ok order by hora_fim desc";
