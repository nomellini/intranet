...
<div align="center"> 
        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" --> 
             <p>&nbsp;</p>
             <p align="center"><font color="#666666" face="Verdana, Arial, Helvetica, sans-serif" class="Titulo"><a href="/Apoio/index.php">Apoio</a> : E-mails</font></p>
             <table width="60%"  border="0" align="center">
               <tr>
                 <td><div align="center">Clique <a href="/Apoio/alteraremaildtm.php">aqui</a> para cadastrar mais um e-mail</div></td>
               </tr>
             </table>
 ...
 if ($ordem=="") { $ordem="nome";};
 $sSQL = "SELECT * FROM emaildtm where empresa = 1 order by nome"; 
 $result = mysql_query($sSQL);    

?>
                           <table border="0" cellpadding="1" width="100%" cellspacing="1">
                             <tr bgcolor="#FFFFFF" class="TabelaRotulo">
                               <td width="50%"><div align="center" class="style3"><font size="1">Datamace</font></div></td>
                               <td width="50%"><div align="center" class="style3"><font size="1">e-mail</font></div></td>
                             </tr>
                             <?
...
?>
                             <tr>
                               <td width="50%" bgcolor="#c0c0c0" class="TabelaPadrao"><font size="1"> <?echo "<a href=alteraremaildtm.php?id=$id>$nome</a>"?> </font></td>
                               <td width="50%" bgcolor="#c0c0c0" class="TabelaPadrao"><font size="1"> <?echo $email?> </font></td>
                             </tr>
                             <?
  };
 ?>
 ...
 mysql_select_db(datamace);
 if ($ordem=="") { $ordem="nome";};
 $sSQL = "SELECT  * FROM emaildtm where empresa = 3 order by nome;"; 
 $result = mysql_query($sSQL);    
?>
                           <table border="0" cellpadding="1" width="100%" cellspacing="1">
                             <tr bgcolor="#FFFFFF" class="TabelaRotulo">
                               <td width="50%"><div align="center" class="style3"><font size="1">Intersystem</font></div></td>
                               <td width="50%"><div align="center" class="style3"><font size="1">e-mail</font></div></td>
                             </tr>
                             <?
 while ($linha = mysql_fetch_object($result)) {
