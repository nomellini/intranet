...
include_once ('cabeca.inc.php');
 ...
 if ($cod_sistema) 
     $sSQL = "SELECT * FROM sistemas  where id like '%$cod_sistema%' order by $ordem, id ;";
 else
        ...
        <table width="100%" border="0" bordercolorlight="#FFCC30" bordercolordark="#FFCC30" class="bgTabela">
          <tr>
            <td width="77%" align="left" valign="top" bgcolor="#FFFFFF"><!-- #BeginEditable "Centro" --> 
             <div align="center" class="style3 style6 style5 style7 style7"><strong><span class="style8">Lista de Sistemas</span><br>
                   <br />
               </strong><br>
             </div>
                     ...
                     <tr>
                       <td width="100%">
                           <table border="1" cellpadding="1" width="100%" cellspacing="1">
                             <tr bgcolor="#FFFFFF">
                               <td width="28%" bgcolor="#006699"><span class="style1 style5"><strong>C&oacute;digo do Sistemas </strong></span></td>
                               <td width="72%" bgcolor="#006699"><span class="style5"><strong><a href="versistemas.php?ordem=descricao" class="style1"><strong>Descri&ccedil;&atilde;o do Sistema </strong></a></strong></span></td>
                             </tr>
                             <?
...
?>
                             <tr>
                               <td width="28%"><span class="style5"><?echo "<a href=resultsistemas.php?id=$id>$cod_sistema</a>"?></span> </td>
                               <td><span class="style5"><?echo "<a href=resultsistemas.php?id=$id>$descricao</a>"?></span></td>
                             </tr>
                             <?
  };
 ?>
