...
include_once ('cabeca.inc.php');
 ...
 if ($nome) 
     $sSQL = "SELECT  * FROM avaliacao2 where nome like '%$nome%' order by $ordem, nome ;";
 else
     $sSQL = "SELECT  * FROM avaliacao2 order by $ordem, nome ;";
...
<p align="center">Rela&ccedil;&atilde;o de treinandos - Exerc&iacute;cios de fixa&ccedil;&atilde;o do treinamento </p>
<table width="70%" border="0" align="center">
  <tr>
    <td><form method="post" action="veravalia2.php">

      <table width="100%" border="1" align="left">
        <tr bgcolor="#D7FFFF">
          <td align="center" valign="middle" bgcolor="#006699"><span class="style1 style9"><strong>Procure pelo nome do treinando </strong></span></td>
          </tr>
        <tr>
          <td align="center" valign="middle" bgcolor="#DBF0EE"><span class="style10 style10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Nome </font>
              <input name="nome" type="text" id="nome" size="60" />          
              </span>            <input name="Submit" type="submit" class="style10" value="procura" />          </td>
          </tr>
      </table>
    </form></td>
  </tr>
...
?>
                <tr>
                  <td bgcolor="#006699"><a href="veravalia2.php?ordem=empnome" class="style16 style1 style5 style7 style5 style5"><strong>Nome da empresa </strong></a></td>
                  <td bgcolor="#006699"><span class="style1 style9"><strong>Nome</strong></span></td>
                  <td bgcolor="#006699"><a href="veravalia2.php?ordem=data1" class="style1 style9"><strong>Data</strong></a></td>
                </tr>
                <tr>
                  <td ><span class="style6 style14 style18 style13"><span class="style14 style17"> <?echo "<a href=resultavalia2.php?id=$id>$empnome  </a>"?> </span></span></td>
                  <td ><span class="style6 style14 style18 style13"><span class="style14 style17"> <?echo "<a href=resultavalia2.php?id=$id>$nome</a>"?> </span></span></td>
                  <td width="16%" ><span class="style6 style14 style18 style13"><span class="style14 style17"> <?echo "<a href=resultavalia2.php?id=$id>$data1</a>"?> </span></span></td>
                </tr>
                <?
  };
 ?>
