  ...
  <tr> 
    ...
    <?=$ligEspera?>
      ...
      <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#003366" >
        <tr bgcolor="#003366"> 
          <td width="15%" height="16" align="center"><span class="style22">Aguarda</span></td>
          <td width="6%" align="center"><span class="style22">Linha</span></td>
          <td width="48%" ><span class="style22">Cliente</span></td>
          <td width="12%" align="center">Grau</td>
          <td width="12%" align="center"><span class="style22">Tempo</span></td>
          <td width="19%"><span class="style22">Produto</span></td>
          <td width="19%"><span class="style22">Estado</span></td>
        </tr>
        <?
  $sql = "select cliente.grau, motivo_status, FL_ATIVO, qtde_aguarde,  id, cliente.cliente, sec_to_time(  time_to_sec(curtime()) - time_to_sec(hora_inicio)  ) as espera, ";
...
?>
        ...
        <tr bgcolor="<?=$cor_fundo?>"> 
          <td width="15%" align="center"><?=$qtde?> </td>
          ...
          <td width="48%"> 
			...
			?></td>
          <td width="12%" align="center" bgcolor="<?=$cor?>"><?=$Grau?></td>
          <td width="12%" align="center">
            <?=$espera?></td>
          <td width="19%">
            <?=$produto?></td>
          <td width="19%"><a href="?acao=alterna&id=<?=$idligacao?>"><?=$link?></a></td>
        </tr>
        <?
 }
?>
    ...
    <td align="center" valign="middle"><span class="style17">Liga&ccedil;&otilde;es 
      ...
      <?=$ligTransf?>
        ...
        <tr bgcolor="#003366"> 
          ...
          <td width="8%"><span class="style12">O Grau</span></td>
