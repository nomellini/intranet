...
<form name="form" method="post" action="tempoporsistema.php">
...
<input name="Button" type="button" class="unnamed1" value="Todos" onClick="javascript:document.form.limite.value='99999';document.form.submit();">
...
<table width="98%" border="0" align="center" cellpadding="1" cellspacing="1" class="Mtable">
  <tr>
    <td width="47%" height="19" align="left" bgcolor="#666666"><strong><font color="#FFFFFF">Sistema</font></strong></td>
...
?>
  <tr>
    <td height="19" align="left">
      <?=++$soma?>
      .
      <a href="tempoporcategoria.php?datai=<?=$datai?>&dataf=<?=$dataf?>&sistema=<?=$linha->id_sistema?>&limite=99999">
	  <?=$linha->sistema?>
	  </a>
    </td>
    <?
...
<br>
<div align="center">
<img src="../graficos/g_tempoporsistema.php?datai=<?=$datai?>&dataf=<?=$dataf?>&sistema=<?=$sistema?>" alt="Gr&aacute;fico" >
 </div>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
