...
<title>Incluindo sintomas e soluções</title>
<!-- #EndEditable --> 
...
if (re==13) 
  { 
   form1.causa.value=document.form1.causa.value + "<br>";
  }
}
function teclado2() {
var ch = String.fromCharCode(window.event.keyCode);
...
if (re==13) 
  { 
   form1.solucao.value=document.form1.solucao.value + "<br>";
  }
}
...
<?
 ...
 $sSQL = "SELECT * FROM titulo where id=$id_titulo;"; 
...
?> 
              ...
              <blockquote><br>
                <br>
                Problema : <br>
                <b><?=$titulo?></b> </blockquote>
              <form method="post" action="novo03.php" name="form1">
                <table width="90%" border="0" cellspacing="1" cellpadding="1" align="center">
                  ...
                  <tr> 
                    <td> 
                      <textarea name="causa" cols="50" rows="5" onKeyPress="teclado1();"></textarea>
                    </td>
                  </tr>
                  <tr> 
                  ...
                  <tr> 
                    <td> 
                      <textarea name="solucao" cols="50" rows="5" onKeyPress="teclado2();"></textarea>
                    </td>
                  </tr>
                  <tr> 
                    <td> 
                  ...
                  <tr> 
                    <td><a href="novo.php">Incluir mais um T&iacute;tulo</a><br>
                      <a href="index.php">Ir para Index</a><br>
                      <a href="manut.php">Manuten&ccedil;&atilde;o</a> <br>
                    </td>
                  </tr>
                  <tr> 
                    <td>&nbsp;</td>
