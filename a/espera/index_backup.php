                  ...
                  <td><font size="2">Pesquisa (por c&oacute;digo ou nome)</font> 
                    ...
                    <table width="100%"  border="0" cellspacing="1" cellpadding="1">
                      <tr bgcolor="#003333">
                        ...
                        <td width="36%"><span class="style5">Raz&atilde;o social </span></td>
                        <td width="46%"><span class="style5">Consultor</span></font></td>
                      </tr>
<?
  $sql = "";
...
function fnc_transfereSemEspera() {
  if (document.espera.id_consultor.value == 0) {
	...
	document.form.id_consultor.focus();
	return false;	
  }  
...
function fnc_espera() {
  ...
  if (document.espera.idcliente.value == "") {
    window.alert("Primeiro você deve escolher um cliente");
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr valign="top"> 
          <td width="43%"> 
            <table width="100%" border="0" cellpadding="1" cellspacing="1" class="Mtable">
              <tr bgcolor="#003333"> 
                <td bgcolor="#003366"><strong><font color="#FFFFFF" size="1">Consultor</font></strong></td>
              </tr>
<?
  $sql = "select nome, id_usuario from usuario where area  = 1 and ativo=1 order by nome;";
  $result = mysql_query($sql);
...
?>
              <tr> 
                <td><font size="1"><a href="javascript:consultor('<?=$linha->nome?>', <?=$linha->id_usuario?>);"> 
                  <?=$linha->nome?>
                  </a></font></td>
              </tr>
              <?
