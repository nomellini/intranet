...
<table width="99%" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td width="43%"><font size="1">Usu&aacute;rio <font color="#FF0000">:<b> 
      <?=$nomeusuario?>
      </b></font></font></td>
    <td width="57%" align="right" valign="top"><a href="/a/">Ir para oSAD</a></td>
  </tr>
</table>
<table width="99%" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    <td width="75%" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="50%"><table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr> 
                <td> <a href="inicio.php?<?=dataLink(somaDia(-1, $dia, $mes, $ano))?>"><img src="figuras/anterior.gif" alt="Anterior" width="20" height="20" border="0" align="absmiddle"></a> 
                  ...
                  <span id="vc"></span><br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <?=$BRDays3[  date("w", mktime(0,0,0,$mes,$dia,$ano,0)) ]?>
                </td>
              </tr>
            </table></td>
        ...
        <tr> 
          <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#003366">
              <tr> 
                <td height="21" bgcolor="#FFFFFF">Compromissos :: <a href="../../agenda/novocompromisso.php?<?=dataLink(somaDia(0, $dia, $mes, $ano))?>">Novo 
                  Compromisso</a> <br> 
                                  ...
                                  <td bgcolor="<?=$CellBgColor?>"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                                      <tr valign="top"> 
                                        <td width="24%"> 
                                          ...
                                          - 
                                          <?=substr($linha->horafim,0,5)?><a href=editar.php?id_compromisso=<?=$linha->id?>> 
                                          Editar</td>
...
?>
      ...
      <br> </td>
    <td width="25%" align="right" valign="top"><?echo $cal->getMonthView($mes, $ano);?><p>
...
//		    $teste = somaDia($i, $hDia, $hMes, $hAno);
			...
			*/			
			$sql = "";			  
			$sql .= "Select compromisso.id, usuario.nome as nome, compromisso.hora, compromissousuario.id_usuario ";
			$sql .= "FROM ";
			$sql .= "  compromisso, compromissousuario, usuario ";
			$sql .= "WHERE ";
            $sql .= "  compromisso.excluido <> 1 and ";
...
<table width="98%" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td height="400" align="left" valign="top"><iframe name="detalhe" src="nada.htm" ALLOWTRANSPARENCY="true" frameborder="0" width="100%" height="100%" align="center"></iframe></td>
  </tr>
</table>
<A HREF=todos.php?id_usuario=<?=$ok?> TARGET=detalhe class=fundoclaro>.</a>
</body>
</html>
<?
