...
<script>
 function seleciona(opcao)
 {
  ...
  for (a=0; a<document.form1.length;a++)
  {
   if (document.form1.elements[a].type=="checkbox")
  {
   document.form1.elements[a].checked=x;
  }
 }
}
</script>
...
<form id="form1" name="form1" method="post" action="">
 ...
 if ($evento) 
     $sSQL = "SELECT  * FROM relacaoip where evento like '%$ip%' order by $ordem, ip ;";
 else
     $sSQL = "SELECT  * FROM relacaoip order by $ordem, ip ;";
...
?>
                <table border="1" cellpadding="1" width="100%" cellspacing="1">
                  <tr bgcolor="#FFFFFF">
                    <td width="29%" bgcolor="#006699"><span class="style1 style4"><strong>N&uacute;mero do IP </strong></span></td>
                  </tr>
                  <?
...
?>
                ...
                <table border="1" cellpadding="1" width="100%" cellspacing="1">
                  <tr>
                    <td width="39%"> <span class="style4"><?echo "$ip"?></span> </td>
                    <td width="34%" ><span class="style4"><?echo "$id"?></span></td>
 ...
 ?>
          ...
          <tr>
            <td width="72%" bgcolor="#FFFFFF"><label>
                <input name="Excluir" type="submit" class="style4" id="excluir" value="Excluir" />
                </label>
            </td>
            <td width="28%" bgcolor="#FFFFFF"><div align="right" class="style3"><span class="style4 style4"><font face="Verdana, Arial, Helvetica, sans-serif">Marcar todos</font>
                  <input type="checkbox" name="Marca" onClick="seleciona(1)" />
                  <br>
                  <font face="Verdana, Arial, Helvetica, sans-serif">Desmarcar
                    todos
                  <input type="checkbox" name="Desmarca" onClick="seleciona(0)" />
