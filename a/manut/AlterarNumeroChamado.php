<form action="MudaNumeroChamado.php" method="post" name="form" >
	Chamado Atual 
...
<script language="javascript">
	...
	function vai() {
		if ( window.confirm("Alterar " + document.form.chamado_origem.value + " por " + document.form.chamado_destino.value + " ? ")) {
