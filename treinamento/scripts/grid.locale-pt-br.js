...
$.jgrid = {
	...
	search : {
	    ...
	    Find: "Procurar",
	    Reset: "Resetar",
	    odata : ['igual a', 'diferente de', 'menor que', 'menor ou igual a','maior que','maior ou igual a', 'come&ccedil;ando com','n&atilde;o come&ccedil;a com','dentro de','fora de','termina com','n&atilde;o termina com','cont&eacute;m','n&atilde;o cont&eacute;m'],
	...
	edit : {
	    ...
	    bCancel: "Cancelar",
		bClose: "Fechar",
		saveData: "Os dados foram alterados! Salvar altera&ccedil;ões?",
		bYes : "Sim",
		bNo : "N&atilde;o",
		bExit : "Cancelar",
	    msg: {
			...
			url: "n&atilde;o &eacute; uma URL v&aacute;lida. Prefixo obrigat&oacute;rio ('http://' or 'https://')",
			nodefined : " n&atilde;o est&aacute; definido!",
			novalue : " um valor de retorno &eacute; obrigat&oacute;rio!",
			customarray : "Fun&ccedil;&atilde;o customizada deve retornar um array!",
			customfcheck : "Fun&ccedil;&atilde;o customizada deve estar presente em caso de valida&ccedil;&atilde;o customizada!"
		}
	},
	view : {
